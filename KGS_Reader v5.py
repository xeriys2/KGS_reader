    ...
    def extract_field(self, text, field_name, patterns):
        if field_name == "Тип коммуникации":
            allowed_communications = [
                ...
                "СОУЭ", "СКУД",
                "Канализация", "Нап канализация", "Сам канализация",
                "Водовыпуск", "Кабель защ", "Газ", "Теплотрасса"
            ]
            patterns += [
...
class App(ttk.Frame):
    ...
    def _build_bottom(self):
        ...
        self.btn_cancel = ttk.Button(runrow, text="Отмена", state="disabled", command=self.cancel_processing)
